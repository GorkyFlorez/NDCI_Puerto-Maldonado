...
<qgis version="3.26.0-Buenos Aires">
  <identifier>Carretera_interoceanica</identifier>
  <parentidentifier></parentidentifier>
  <language>SPA</language>
  <type>dataset</type>
  <title>Carretera_interoceanica</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="Personal GeoDatabase Feature Class" mimeType="" type="Local Area Network" format="" description="" url="file://\\ADMIN-PC\D$\POT_2011\MAPA BASE\GEODATABASE\POT_2011.mdb" size=""/>
  </links>
  <fees></fees>
